...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='runs_train/GSconv-ablotion-ReLU_1/weights/best.pt', help='training model path')
    ...
    parser.add_argument('--project', type=str, default='runs/test', help='project name')
    parser.add_argument('--name', type=str, default='yolov8n_SIRST2', help='experiment name (project/name)')
    ...
    parser.add_argument('--iou', type=float, default=0.35, help='intersection over union (IoU) threshold for NMS')
